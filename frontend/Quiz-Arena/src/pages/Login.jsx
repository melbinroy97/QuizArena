...
import { Trophy, Mail, Lock, ArrowRight, Brain, Target, Eye, EyeOff } from "lucide-react";
    ...
    <div className="min-h-[calc(100vh-80px)] flex items-center justify-center relative overflow-hidden bg-gray-50">
      ...
      >
        ...
        <div className="relative text-center mb-8">
          ...
          <motion.p variants={itemVariants} className="text-gray-500">Enter your credentials to access your account</motion.p>
        </div>
