      ...
      <div className="max-w-4xl mx-auto relative z-10">
        ...
        >
          ...
          <p className="text-gray-600">
            The quiz has ended! Here are the champions.
          </p>
        </motion.div>
        ...
        <div className="mt-8 flex justify-center gap-4">
          <button
            ...
            className="flex items-center gap-2 px-6 py-3 bg-violet-600 text-white rounded-xl hover:bg-violet-700 transition-all font-medium shadow-lg shadow-violet-200"
          >
